...
def installTools():
    ...
    if newUser and confirmInstallTools.lower() == "y":
        # Default Tools
        ...
        if doChange.returncode == 0:
            ...
            # Installing Sn1per
            print(Fore.YELLOW + "\nInstalling Sn1per...\n")
            installSn1per = f'cd {path} && echo {sudo_password} | sudo git clone https://github.com/1N3/Sn1per.git;' 
            ...
            print(Fore.YELLOW + "\nInstalling Sherlock...\n")
            installSherlock = f'cd {path} && echo {sudo_password} | sudo git clone https://github.com/sherlock-project/sherlock.git'
            ...
            if doInstallVscode1.returncode == 0:
                ...
                installVscode2 = f'cd {path} && echo {sudo_password} | curl https://packages.microsoft.com/keys/microsoft.asc | gpg --dearmor > packages.microsoft.gpg'
            ...
            if doInstallRpm.returncode == 0:
                print(Fore.YELLOW + f'Succeeded in installing RPM package manager at\n{thisTime}')
            else:
                print(Fore.RED + f'Failed to install RPM package manager...\nSkipping...\n')
